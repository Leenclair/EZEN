...
public class StringTest {
	...
	public static void main(String[] args) {
		...
		*/
		...
		if(str2==str3) { //참조형에서는 == 이 주소 비교
			System.out.println("str2, str3는 같은 주소=> 동일 인스턴스 참조");
		}else {
		...
		if(str4==str5) {
			System.out.println("str4, str5는 같은 주소=> 동일 인스턴스 참조");
		}else {
			System.out.println("str4, str5는 다른 인스턴스 참조");
		}

		if(str1==str4) {
			System.out.println("str1, str4는 같은 주소=> 동일 인스턴스 참조");
		}else {
